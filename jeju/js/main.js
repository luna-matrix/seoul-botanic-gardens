...
window.JEJU_MAPS = {
  ...
  jejuCity: [
    {name:"자매국수",en:"Jamae Guksu",lat:33.5013,lng:126.5245,type:"local",cuisine:"고기국수",desc:"The 'two pillars' of Jeju meat noodles. Built a new building for the crowds.",query:"자매국수 제주시 향골남길"},
    {name:"올래국수",en:"Ollae Guksu",lat:33.4952,lng:126.5335,type:"local",cuisine:"고기국수",desc:"Single-menu temple of gogi-guksu. Milky-white, deep broth.",query:"올래국수 제주시 귀아랑길"},
    {name:"골막식당",en:"Golmak Sikdang",lat:33.4958,lng:126.5275,type:"gem",cuisine:"고기국수",desc:"The 'original' meat noodle shop near the airport. On TV three times.",query:"골막식당 제주시 이도이동"},
    {name:"국시트멍",en:"Guksiteumeong",lat:33.4868,lng:126.4815,type:"local",cuisine:"고기국수",desc:"Thick plump noodles, special pork sauce. Student favourite.",query:"국시트멍 제주시 진군길"},
    {name:"국수마당",en:"Guksumadang",lat:33.5098,lng:126.5232,type:"local",cuisine:"고기국수",desc:"First on Noodle Street. Clean broth, open till 2 AM.",query:"국수마당 제주시 삼성로"},
    {name:"제주미담",en:"Jeju Midam",lat:33.5078,lng:126.5525,type:"local",cuisine:"고기국수",desc:"3× the pork of normal bowls. Makchang sundae legend.",query:"제주미담 제주시 가령로"},
    {name:"모던 돔베",en:"Modern Dombae",lat:33.4345,lng:126.5645,type:"gem",cuisine:"고기국수",desc:"Upscale soba-noodle gogi-guksu with charcoal-grilled black pork.",query:"모던돔베 제주시 천일로"},
    {name:"돈사돈 본점",en:"Donsadon",lat:33.5025,lng:126.5255,type:"local",cuisine:"흑돼지",desc:"Charcoal black pork institution. Self-grill, reservation essential.",query:"돈사돈 제주시 연동 흑돼지"},
    {name:"신해바다",en:"Sinhaebada",lat:33.5095,lng:126.5125,type:"gem",cuisine:"해장국",desc:"Early-morning hangover soup near the airport. Braised filefish.",query:"신해바다 제주시 공항근처 해장국"},
    {name:"팔도수산식당",en:"Paldo Susikdang",lat:33.5168,lng:126.5178,type:"gem",cuisine:"해산물",desc:"7 AM swordfish mulhoe & sashimi rice bowls near the port.",query:"팔도수산식당 제주시 임항로"},
    {name:"순옥이네명가 본점",en:"Sunok's House",lat:33.4922,lng:126.4985,type:"local",cuisine:"해산물",desc:"Grilled mackerel & water sashimi. Great for groups.",query:"순옥이네명가 제주시 도공로"},
    ...
    {name:"만강촌옛날칼국수",en:"Mangangchon Kalguksu",lat:33.5148,lng:126.5048,type:"local",cuisine:"칼국수",desc:"Half-chicken kalguksu with unlimited noodle refills. Budget price.",query:"만강촌옛날칼국수 제주시 월랑로"}
  ],

  // Island-wide restaurants
  island: [
    // West/Northwest
    {name:"돈사촌",en:"Donsachon",lat:33.4728,lng:126.3255,type:"gem",cuisine:"흑돼지",desc:"The ORIGINATOR of thick-cut 근고기. Charcoal briquette fire, anchovy sauce.",query:"돈사촌 제주시 애월읍 흑돼지"},
    {name:"고향흑돼지",en:"Gohyang Heukdwaeji",lat:33.4078,lng:126.2458,type:"local",cuisine:"흑돼지",desc:"Ocean-view black pork near Hyeopjae Beach. Owner grills for you.",query:"고향흑돼지 제주시 한림읍 한림해안로"},
    {name:"밥깡패",en:"Bapgangpae",lat:33.4062,lng:126.2578,type:"gem",cuisine:"퓨전",desc:"Haenyeo pasta & black pork tofu curry. Closes when sold out.",query:"밥깡패 제주시 한림읍"},
    {name:"블랙씨걸",en:"Black Sea Girl",lat:33.4058,lng:126.2498,type:"gem",cuisine:"해산물",desc:"Fresh mackerel sashimi + jiritang stew. Clean aquariums, abundant sides.",query:"블랙씨걸 제주시 한림읍 한림서길"},
    {name:"꽁순이네",en:"Kongsun-i-ne",lat:33.4278,lng:126.3158,type:"gem",cuisine:"고기국수",desc:"Hidden gem in Aewol mid-mountain area. Sells out fast.",query:"꽁순이네 제주시 애월읍 중산간서로"},
    // East
    {name:"옛날옛적",en:"Yennalyennyeok",lat:33.4598,lng:126.9398,type:"local",cuisine:"흑돼지",desc:"Local-approved black pork in tourist-heavy Seongsan. Subtle seasoning.",query:"옛날옛적 제주시 성산읍 흑돼지"},
    {name:"가시아방 국수",en:"Gasiabang Guksu",lat:33.4595,lng:126.9298,type:"local",cuisine:"고기국수",desc:"Near Sunrise Peak. High turnover, couple set is a must.",query:"가시아방국수 서귀포시 성산읍 섭지코지로"},
    {name:"해녀의 집",en:"Haenyeo House",lat:33.5238,lng:126.8530,type:"gem",cuisine:"해산물",desc:"Fresh-caught abalone & conch seafood ramen. Locals over tourists.",query:"해녀의집 제주시 구좌읍 월정리"},
    {name:"국수마을",en:"Guksu Maeul",lat:33.4618,lng:126.9348,type:"local",cuisine:"고기국수",desc:"Sacred place for taxi drivers. 20 years. Sea urchin kalguksu.",query:"국수마을 서귀포시 성산읍 동류암로"},
    // South/Seogwipo
    {name:"고씨네 천지국수",en:"Go's Cheonji Noodles",lat:33.2488,lng:126.5642,type:"gem",cuisine:"고기국수",desc:"Anchovy-meat broth unique to Jeju. Inside Olle Market.",query:"고씨네천지국수 서귀포시 중앙로"},
    {name:"자연수산",en:"Jayeon Sushan",lat:33.2458,lng:126.5602,type:"gem",cuisine:"해산물",desc:"Fresh mackerel sashimi, rare even for locals. Closes when fish runs out.",query:"자연수산 서귀포시 서호남로"},
    {name:"몰질 식육식당",en:"Moljil Sikyuk",lat:33.2238,lng:126.3098,type:"gem",cuisine:"복지리",desc:"Pufferfish stew with milt + incredible meat jjamppong ₩8,000.",query:"몰질식육식당 서귀포시 이어도로"},
    {name:"청송 고기국수",en:"Cheongsong Gogi-guksu",lat:33.2488,lng:126.5658,type:"local",cuisine:"고기국수",desc:"Best-value old-school gogi-guksu ₩7,000. Open till midnight.",query:"청송고기국수 서귀포시 동홍로"},
    {name:"고집돌우럭",en:"Gojip Dolureok",lat:33.2528,lng:126.4158,type:"local",cuisine:"해산물",desc:"Braised rockfish & filefish sashimi near Jungmun. Locals over tourists.",query:"고집돌우럭 서귀포시 중문동"},
    {name:"맛존디 본점",en:"Matjondi",lat:33.2298,lng:126.5598,type:"gem",cuisine:"보말죽",desc:"Reimagined Jeju heritage food. Sea snail porridge & meat noodles.",query:"맛존디 서귀포시 태평로"},
    {name:"중앙식당",en:"Jungang Sikdang",lat:33.2492,lng:126.5638,type:"gem",cuisine:"국밥",desc:"Hidden near Olle Market. Rich pork bone soup in stone bowl.",query:"중앙식당 서귀포시 올레시장"},
    {name:"제미니국수 서귀포점",en:"Gemini Noodles",lat:33.2198,lng:126.6198,type:"local",cuisine:"고기국수",desc:"Near Sogeummak. Fresh hand-pulled noodles, family-farmed ingredients.",query:"제미니국수 서귀포시 쇠소깍로"}
  ],

  // Hot hits / trending spots
  hotHits: [
    {name:"제주 몬트락 버거",en:"Jeju Montlac Burger",lat:33.4890,lng:126.5280,type:"special",cuisine:"흑돼지버거",desc:"SNS-viral black pork patty burger. The Jeju burger trend.",query:"제주몬트락버거 제주시"},
    {name:"블랙버거하우스",en:"Black Burger House",lat:33.4912,lng:126.5295,type:"special",cuisine:"흑돼지버거",desc:"The other viral black pork burger. SNS sensation.",query:"블랙버거하우스 제주시"},
    {name:"오설록 티뮤지엄",en:"Osulloc Tea Museum",lat:33.3048,lng:126.2894,type:"cafe",cuisine:"말차한라봉젤라또",desc:"Jeju-grown matcha + hallabong gelato. Iconic dessert destination.",query:"오설록티뮤지엄 서귀포시 안덕면"},
    {name:"귤향당",en:"Gulhyangdang",lat:33.4896,lng:126.5248,type:"cafe",cuisine:"감귤크림카스텔라",desc:"Moist tangerine cream castella. The Jeju bakery trend.",query:"귤향당 제주시 감귤카스텔라"},
    ...
    {name:"우도왕자",en:"Udo Prince",lat:33.4964,lng:126.9432,type:"cafe",cuisine:"땅콩아이스크림",desc:"Udo Island peanut ice cream, cream bread, latte. The ferry-trip classic.",query:"우도왕자 제주 우도 땅콩아이스크림"},
    {name:"한라면옥",en:"Hallamyeonok",lat:33.5100,lng:126.5300,type:"special",cuisine:"한라산국수",desc:"Hallasan Noodles — bibim noodles topped with broth ice shaped like Mt. Hallasan.",query:"한라면옥 제주시 한라산국수"},
    {name:"천일만두",en:"Cheonil Mandu",lat:33.2482,lng:126.5635,type:"special",cuisine:"중식만두",desc:"Authentic Chinese dumplings in Seogwipo. Snowflake 눈꽃만두 + mapo tofu.",query:"천일만두 서귀포시 서문로"},
    {name:"희신이네",en:"Heuisinne",lat:33.2471,lng:126.5652,type:"special",cuisine:"닭요리중식",desc:"Chicken cold noodles + kanpunggi. YouTube 또간집 featured.",query:"희신이네 서귀포시 서홍로"},
    {name:"봄날",en:"Bomnal",lat:33.4661,lng:126.3076,type:"cafe",cuisine:"감성카페",desc:"Aewol ocean-view cafe. Movie filming location. Yellow bus photo zone.",query:"봄날 제주시 애월읍 해안도로"},
    {name:"리브레 제주",en:"Libre Jeju",lat:33.3938,lng:126.2370,type:"cafe",cuisine:"오션뷰카페",desc:"Hyeopjae Beach aesthetic cafe. Full-wall glass ocean view.",query:"리브레제주 제주시 한림읍 협재해변"},
    {name:"카페 월정리101",en:"Woljeongri 101",lat:33.5542,lng:126.7332,type:"cafe",cuisine:"인스타핫플",desc:"Hot on Instagram for its ocean view. Woljeongri beach.",query:"카페월정리101 제주시 구좌읍"},
    {name:"카페 테라로사 제주",en:"Terrarosa Jeju",lat:33.2493,lng:126.5654,type:"cafe",cuisine:"커피전문",desc:"Coffee specialty + vibe. Seogwipo's top roaster.",query:"테라로사 서귀포 커피"},
    {name:"서귀다원",en:"Seogwi Dawon",lat:33.3051,lng:126.4331,type:"cafe",cuisine:"티하우스",desc:"Tea house near Geum Oreum. No-kids zone. Green nature views.",query:"서귀다원 서귀포시 금오름"},
    {name:"동문시장",en:"Dongmun Market",lat:33.5141,lng:126.5219,type:"special",cuisine:"시장먹거리",desc:"Jeju's biggest traditional market. Street food, tangerines, 빙떡.",query:"동문시장 제주시"},

    // Bakeries & Bagels
    {name:"런던베이글뮤지엄 제주",en:"London Bagel Museum",lat:33.5475,lng:126.6735,type:"cafe",cuisine:"베이글",desc:"SNS-viral bagels. Ocean-view dining room. Wait required — takeaway is faster.",query:"런던베이글뮤지엄 제주시 구좌읍 동복로"},
    {name:"블루메베이글",en:"Blume Bagel",lat:33.4913,lng:126.5288,type:"cafe",cuisine:"베이글",desc:"Healthy bagels — no egg/butter/oil. Jeju milk cream cheese. Near airport.",query:"블루메베이글 제주시 가령로4길"},
    {name:"우드노트 베이커리",en:"Woodnote Bakery",lat:33.2258,lng:126.3108,type:"cafe",cuisine:"사워도우",desc:"French croissants &amp; sourdough in a stone-wall converted space. #1 bakery 2025.",query:"우드노트베이커리 서귀포시 안덕면 화순리"},
    {name:"백마베이크",en:"Baekma Bake",lat:33.5005,lng:126.5308,type:"cafe",cuisine:"사워도우",desc:"48-hour cold-fermented natural sourdough. 'Bread that sits comfortably in your stomach.'",query:"백마베이크 제주시 사워도우"},
    {name:"웃뜨리",en:"Utturi",lat:33.4648,lng:126.3138,type:"cafe",cuisine:"베이커리",desc:"50+ bakery items using 쉰다리 fermentation starter. Free tangerine picking in their 귤밭.",query:"웃뜨리 제주시 애월읍 광성로"},
    {name:"아베베 베이커리",en:"Abebe Bakery",lat:33.5142,lng:126.5220,type:"cafe",cuisine:"도넛",desc:"Dongmun Market institution. 8,945 blog reviews. Peanut cream donuts, milk bread.",query:"아베베베이커리 제주시 동문시장"},
    {name:"빵귿",en:"Bbang-Gyul",lat:33.2762,lng:126.6208,type:"cafe",cuisine:"감귤베이커리",desc:"Tangerine croissant, tangerine castella. Open-run required — sells out fast.",query:"빵귿 서귀포시 남원읍 태위로"},

    // Hard-to-book
    {name:"이모카세 제주",en:"Emocase Jeju",lat:33.4064,lng:126.2587,type:"special",cuisine:"한식파인다이닝",desc:"Black/White Chef Kim Mi-ryeong's Jeju debut. '바다술상' concept. Sold out in 2 hours on opening day.",query:"이모카세 제주시 한림읍 한림해안로"},
    {name:"더 스푼",en:"The Spoon",lat:33.5012,lng:126.5315,type:"special",cuisine:"이탈리안",desc:"Jeju seafood Italian. Sea urchin pasta, octopus saffron. Catchtable booking. Solo bar.",query:"더스푼 제주시 이탈리안 파스타"},
    {name:"엘엠엔티",en:"LMNT",lat:33.2530,lng:126.4160,type:"special",cuisine:"코스다이닝",desc:"Secret glass building in the forest. Seasonal courses. Instagram DM only. Not on maps.",query:"엘엠엔티 서귀포시 중문 코스다이닝"},
    {name:"서문 수산",en:"Seomun Sushan",lat:33.5015,lng:126.5305,type:"special",cuisine:"오마카세",desc:"Aged fish omakase. Sea snail porridge, shrimp course. Phone reservation + deposit.",query:"서문수산 제주시 숙성회 오마카세"},
    {name:"치저스",en:"Cheeses",lat:33.5480,lng:126.8620,type:"special",cuisine:"라클렛",desc:"Raclette steak — cheese waterfall. Naver booking opens Tuesdays. Food-truck roots.",query:"치저스 제주시 조천읍 라클렛"},

    // Summer/beach & ocean view
    {name:"짐바란 비치",en:"Jimbalan Beach",lat:33.4652,lng:126.3048,type:"cafe",cuisine:"비치카페",desc:"Bali-style beach tables right on the sand. Beach wind + summer vibes.",query:"짐바란비치 제주시 애월읍 애월북서길"},
    {name:"해지개",en:"Haejigae",lat:33.4655,lng:126.3052,type:"cafe",cuisine:"한옥카페",desc:"Hanok concept cafe facing Handam Beach. Bakery + signature drinks.",query:"해지개 제주시 애월읍 한담해변"},
    {name:"원앤온리",en:"One & Only",lat:33.2242,lng:126.3112,type:"cafe",cuisine:"브런치",desc:"3-in-1 view: Sanbangsan + ocean + brother islands. 'Jeju compressed into one spot.'",query:"원앤온리 서귀포시 안덕면 산방로"},
    {name:"아베베 베이커리 비킬라",en:"Abebe Bikilla",lat:33.5478,lng:126.8735,type:"cafe",cuisine:"도넛베이커리",desc:"Right on Conan Beach, east coast. Donut pastries + summer beach combo.",query:"아베베베이커리비킬라 제주시 구좌읍 코난비치"},
    {name:"오드랑베이커리 함덕",en:"Odrang Bakery Hamdeok",lat:33.5424,lng:126.6684,type:"cafe",cuisine:"베이커리",desc:"3-min walk from Hamdeok Beach. Garlic baguette, injeolmi bread. Summer essential.",query:"오드랑베이커리 제주시 조천읉 함덕"},
